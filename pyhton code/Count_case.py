...
def case_counter(input_string):
    uppercase_count=0
    lowercase_count=0
    #Initialize counters and set the name for uppercase and lowercase data

    for char in input_string: #Search through the characters in input string
        if char.isupper():
            uppercase_count +=1 #check if the character is an uppercase letter
        elif char.islower():
            lowercase_count +=1 #check if the character is an lowercase letter
